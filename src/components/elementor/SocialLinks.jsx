...
// Font Awesome 6 icon paths (github, linkedin-in, envelope).
const LINKS = [
  {
    network: 'github',
    label: 'GitHub',
...
// Round icon buttons styled like the original Elementor share buttons.
export default function SocialLinks() {
  return (
    <div className="elementor-grid" role="list">
      {LINKS.map(({ network, label, href, viewBox, path }, index) => (
        <Fragment key={network}>
          {index > 0 && ' '}
          <div className="elementor-grid-item" role="listitem">
            <a
            ...
            >
              <span className="elementor-share-btn__icon">
                <svg aria-hidden="true" className="e-font-icon-svg" viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
                  <path d={path} />
                </svg>
              </span>
            </a>
